...
ClickReveal.prototype = {
    ...
    init: function() {
        ...
        TweenMax.to((_SELECTOR == 'examples2' ? '.examples2-container' : '.examples-container'), 0.3, { autoAlpha: 1 });
    ...
    buildThumbnail: function(i, node) {
        ...
        example.on('click', function(e) {
            ...
            _clickReveal.showFeedback(node.find('label').text(), node.find('feedback1').text());
        });
    ...
    showFeedback: function(label, feedback) {
        var _clickReveal = this;
        var feedbackBox = $(_SELECTOR == 'examples2' ? '.examples2-feedback' : '.examples-feedback');
